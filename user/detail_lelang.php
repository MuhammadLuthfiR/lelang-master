<html>
    <head>
        ...
        $res_pemenang = mysqli_query($GLOBALS["___mysqli_ston"], $query_pemenang);
            ...
            if(isset($_POST['submit'])){
                        ...
                        if($tipe_file != "rar" && $tipe_file != "zip"){
                            ...
                            if(move_uploaded_file($lokasi_file,$direktori)){
                                ...
                                if(mysqli_query($GLOBALS["___mysqli_ston"], $query_confirm)){
                                    ?>
                                        <div class="pad margin no-print">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box box-widget">
                    ...
                    $res =  mysqli_query($GLOBALS["___mysqli_ston"], $que);
                    ...
                    <div class='box-footer box-comments'>
                      <div class='box-comment'>
                        ...
                        <div class='comment-text'>
                          <span class="username">
                            <?php
                            $nama = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `user` WHERE id_user='$id_user'"));
                            ?>
