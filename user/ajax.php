...
elseif($_POST['comentar']!=NULL && $_POST['id_user']!=NULL){
    ...
    $res_admin = mysqli_query($GLOBALS["___mysqli_ston"], $admin);
    ...
    $id_admin=$r_id_admin['id_user'];
        ...
        $result_not_admin = mysqli_query($GLOBALS["___mysqli_ston"], $query_not_admin);
    ...
    $query = "SELECT id_user FROM komentar WHERE id_iklan='$id_iklan'"; // cek id yang ada di komentar
     ...
     while ($row = mysqli_fetch_array($result)) {
         ...
         $cek_result = mysqli_query($GLOBALS["___mysqli_ston"], $cek_query);
