<html>
    <head>
        ...
        mysqli_query($GLOBALS["___mysqli_ston"], $query_update_contrib);
                    ...
                    <div class='box-footer box-comments'>
                      <div class='box-comment'>
                        ...
                        <div class='comment-text'>
                          <span class="username">
                            <?php
                            $nama = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `user` WHERE id_user='".$ro['id_user']."'"));
                            ?>
