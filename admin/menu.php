                      ...
                      <ul class="menu">
                          <?php
                            while ($row_contrib = mysqli_fetch_array($result_contrib)) {
                               ...
                               $result_nama_contrib = mysqli_query($GLOBALS["___mysqli_ston"], $query_nama_contrib);
                    ...
                    <li>                      
                      <ul class="menu">
                          <?php
                                ...
                                $result_notif=  mysqli_query($GLOBALS["___mysqli_ston"], $query_notif);
                                while ($row_notif = mysqli_fetch_array($result_notif)) {
                                    ...
                                    $result_iklan =  mysqli_query($GLOBALS["___mysqli_ston"], $query_iklan);
