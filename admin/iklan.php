<html>
    <head>
        ...
        $batas = 10;
        $value = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM iklan WHERE status='1' AND id_user='$id'"));
                                  ...
                                  <tr>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        echo "<tr>"
                                               ...
                                               . "<td><a href='iklan_hapus.php?id=".$row['id_iklan']."' class='btn btn-danger btn-sm glyphicon glyphicon-edit'> Hapus</a>   "
                                                . "</tr>";
                                    }
                                    ?>
                                </table>
